...
class DetailVC: UIViewController {
    ...
    func updateUserInterface() {
        ...
        temperatureLabel.text = locationDetail.temperature
        summaryLabel.text = locationDetail.summary
        currentImage.image = UIImage(named: locationDetail.icon)
...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        geoCoder.reverseGeocodeLocation(currentLocation, completionHandler: {
            ...
            self.locationDetail = WeatherDetail(name: place, coordinates: currCoord)
            self.locationDetail.getWeather {
                self.updateUserInterface()
            }
        })
